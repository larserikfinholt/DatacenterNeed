...
export function mountWorkforce(root: HTMLElement) {
  ...
  root.innerHTML = `
    ...
    <header class="workforce-header"><div class="workforce-brand"><i data-lucide="zap" aria-hidden="true"></i><div><h1>AI og strømbehov</h1><p>Norsk arbeidsliv · estimat generert september 2026</p></div></div>
      <nav aria-label="Seksjoner"><a href="#comparison">Sammenligning</a><a href="#assumptions">Forklaringer</a><a href="#settings">Innstillinger</a><a href="#occupations">Yrker</a></nav></header>
    <main class="workforce-main" id="analysis">
      ...
      <section class="assumptions-section" id="assumptions" aria-label="Forklaringer"><p class="eyebrow">Forklaringer</p><div class="scope-columns"><div><h2>Hva sammenligningen viser</h2><p>Vi estimerer hvor mye <strong>økt bruk av AI i norsk arbeidsliv</strong> kan øke behovet for datasenterkraft.</p><p>Dette sammenlignes med hvor mye datasenterkapasitet som finnes, bygges og planlegges i Norge.</p><p>Dersom AI-behovet fra norsk arbeidsliv bare utgjør en liten del av kapasiteten, tyder det på at <strong>utbyggingen i hovedsak drives av andre behov enn AI-bruk i norsk arbeidsliv</strong>.</p></div><div><h2>Hva betyr dette?</h2><p>Vi kan derfor ikke lenger si at flere datasentre er nødvendig for at norske bedrifter skal lykkes. Sammenligningen tilsier at norske bedrifter vil klare seg godt også uten at det bygges flere datasentre.</p><p>Samfunnsnytten ved ny kapasitet må i stedet vurderes etter andre kriterier. Det er viktigere hvem kapasiteten styres mot enn at kapasiteten bare øker. Konsesjonsvilkår kan være ett virkemiddel.</p><p>Et mulig diskusjonsforslag er en <strong>«FLOPS-skatt»</strong> i form av et kapasitetskrav: Hva om for eksempel 20 % av regnekapasiteten må dedikeres til forskning og utvikling for norske bedrifter?</p></div><div><h2>Hvordan har vi regnet ut dette?</h2><p>Vi bruker utviklere som referanseyrke, fordi vi antar at dette er blant yrkesgruppene som kan ha høyest og mest kontinuerlig nytte av AI.</p><p>Først estimerer vi hvor mye effekt en aktiv utvikler kan kreve ved omfattende AI-bruk. Deretter skaleres andre yrker relativt til denne referansen basert på yrkestype, arbeidsoppgaver og data fra SSB.</p><p>Til slutt kombineres dette med antall årsverk og forventet AI-adopsjon i norsk arbeidsliv.</p></div></div></section>
